function startClassification(){
    ...
    classifier=ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/32J4oGd8D/model.json',modelReady);
}
...
function gotResults(error, results){
    if(error){
        ...
        document.getElementById("result_confidance").style.color = "rgb("
        +random_number_r+","+random_number_g+","+random_number_b+")";
